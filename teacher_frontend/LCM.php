                                 ...
                                 <div class="card-body">
                                    <div class="questions-container">
                                       <form>
                                          ...
                                          <div class="LCM exercise-container">
                                             <span class="badge">LCM Numbers</span>
                                             <div class="exercise">
                                                <div class="exercise-header d-flex justify-content-between">
                                                   <h6 class="align-self-center">Find the Lowest Common Multiple</h6>
                                                   <div class="actions">
                                    ...
                                    <template>
                                       <div class="form-row form-group">
                                          <div class="col-sm-12 col-lg-6">
                                             ...
                                             <input type="number" class="form-control mb-2" value="20" name="min" id="min">
                                          </div>
                                          <div class="col-sm-12 col-lg-6">
