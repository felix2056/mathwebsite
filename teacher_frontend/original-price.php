...
<head>
   ...
   <title>Original Price Problems</title>
</head>
...
<body>
                                 ...
                                 <div class="card-body">
                                    <div class="questions-container">
                                       <form>
                                          ...
                                          <div class="original-price exercise-container">
                                             <div class="d-flex justify-content-center"><span class="badge">Original Price Problems</span></div>
                                 ...
                                 <div class="card-body">
                                    ...
                                    <template>
                                       <div id="level" class="form-group">
                                          ...
                                          <div class="custom-control custom-radio">
                                             <input type="radio" class="custom-control-input" name="question-type" value="increase" id="increase" checked>
                                             <label class="custom-control-label" for="increase">Original Price Increases</label>
                                          </div>
                                          <div class="custom-control custom-radio">
                                             <input type="radio" class="custom-control-input" name="question-type" value="decrease" id="decrease">
                                             <label class="custom-control-label" for="decrease">Original Price Decreases</label>
                                          </div>
   ...
   <script src="js/original-price.js"></script>
   <!-- Vue -->
