...
<html lang="en">
   ...
   <body>
                                    ...
                                    <div class="card-body">
                                       <div class="questions-container">
                                          <form>
                                             ...
                                             <div class="place-value exercise-container">
                                                <div class="d-flex justify-content-center"><span class="badge">Place Value</span></div>
                                                <div class="exercise">
                                                   <div class="exercise-header d-flex justify-content-between">
                                                      <h6 class="align-self-center">Determine the place value of the underlined digit</h6>
                                                      <div class="actions">
                                                   ...
                                                   <div class="exercise-body mb-3" id='questions'>
      ...
      <script src="js/place-value.js"></script>
      <!-- Vue -->
