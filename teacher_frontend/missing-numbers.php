...
<body>
										...
										<div class="card">
											<div class="card-body">
												<div class="questions-container">
													<form>
														<!--Missing Numbers exercise set-->
														<div class="missing-numbers exercise-container">
															<span class="badge">Missing Numbers</span>
															<div class="exercise">
																<div class="exercise-header d-flex justify-content-between">
																	<h6 class="align-self-center">Fill in the missing numbers</h6>
																	<div class="actions">
												...
												<template>
													<div class="form-row form-group">
														<div class="col-sm-12 col-lg-6">
															...
															<input type="number" class="form-control mb-2" value="0" name="min" id="min">
														</div>
														<div class="col-sm-12 col-lg-6">
															<label>High Range</label>
															<input type="number" class="form-control mb-2" value="100" name="max" id="max">
														</div>
													</div>
													<div class="form-group">
														<div class="form-check">
															<input name="show_from_start" class="form-check-input" type="checkbox" value="" id='show_f'>
															<label class="form-check-label" for="showStart">
                                                Start at the front?
                                             </label>
														
														</div>
														<div class="form-check">
															<input name="show_consect" class="form-check-input" type="checkbox" value="" id='show_c'>
															<label class="form-check-label" for="showConsect">
                                                Show Consecutively?
                                             </label>
	...
	<script src="js/missing-numbers.js"></script>
	<!-- Vue -->
