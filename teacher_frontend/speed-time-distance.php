...
<html lang="en">
   <head>
      ...
      <title>Speed Time Distance</title>
   </head>
   <body>
                                    ...
                                    <div class="card-body">
                                       <div class="questions-container">
                                          <form>
                                             ...
                                             <div class="speed-time-distance exercise-container">
                                                <div class="d-flex justify-content-center"><span class="badge">Speed Time Distance</span></div>
                                                <div class="exercise">
                                    ...
                                    <div class="card-body">
                                       ...
                                       <template>
                                          <div id="level" class="form-group">
                                             ...
                                             <div class="custom-control custom-radio">
                                                <input type="radio" class="custom-control-input" name="sdt" value="speed" id="speed" checked>
                                                <label class="custom-control-label" for="speed">Speed</label>
                                             </div>
                                             <div class="custom-control custom-radio">
                                                <input type="radio" class="custom-control-input" name="sdt" value="distance" id="distance">
                                                <label class="custom-control-label" for="distance">Distance</label>
                                             </div>
                                             <div class="custom-control custom-radio">
                                                <input type="radio" class="custom-control-input" name="sdt" value="time" id="time">
                                                <label class="custom-control-label" for="time">Time</label>
                                             </div>
                                             <div class="custom-control custom-radio">
                                                <input type="radio" class="custom-control-input" name="sdt" value="all" id="all">
                                                <label class="custom-control-label" for="all">Mixed</label>
                                             </div>
                                          </div>
                                       </template>
                                       <template>
      ...
      <script src="js/speed-time-distance.js"></script>
      <!-- Vue -->
