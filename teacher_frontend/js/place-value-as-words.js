...
function generate() {
    var input = {
        ...
        'question-type_mode': $('input[name="question-type_mode"]:checked').val(),
    }
    console.log(input);
    $.ajax({
        type: 'GET',
        url: "scripts/place-value-as-words/generate.php",
        data: input,
...
function schedule() {
    Swal.mixin({
        ...
        if (result.value) {
            quiz = {};
            quiz.topic = 'Place Value As Words';
            ...
            $.ajax({
                type: 'POST',
                url: "scripts/place-value-as-words/schedule.php",
                dataType: "json",
...
function check(q) {
    ...
    for (let i = 0; i < 5; i++) {
        ...
        $.ajax({
            type: 'GET',
            url: "scripts/place-value-as-words/check.php",
            data: {
                'ans': ans,
                'cans': cans
            },
