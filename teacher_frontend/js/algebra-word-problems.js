...
function generate() {
    ...
    $.ajax({
        type: 'GET',
        url: "scripts/algebra-word-problems/generate.php",
        data: input,
...
function schedule() {
    Swal.mixin({
        ...
        if (result.value) {
            quiz = {};
            quiz.topic = 'Algebra World Problems';
            ...
            $.ajax({
                type: 'POST',
                url: "scripts/algebra-word-problems/schedule.php",
                dataType: "json",
...
function check(q) {
    ...
    $.ajax({
        type: 'GET',
        url: "scripts/algebra-word-problems/check.php",
        data: {
            'ans': ans,
            'cans': cans
        },
