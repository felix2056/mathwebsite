...
function generate() {
    ...
    $.ajax({
        type: 'GET',
        url: "scripts/money-conversion/generate.php",
        data: input,
        success: function (result) {
            if (result == '0') {
                alert('Oh Snap! We have issues!');
            } else {
                console.log(result);
...
function schedule() {
    Swal.mixin({
        ...
        if (result.value) {
            ...
            $.ajax({
                type: 'POST',
                url: "scripts/money-conversion/schedule.php",
                dataType: "json",
...
function check(q) {
    ...
    $.ajax({
        type: 'GET',
        url: "scripts/money-conversion/check.php",
        data: {
            'ans': ans,
            'cans': cans
        },
