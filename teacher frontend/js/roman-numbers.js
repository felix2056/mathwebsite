...
function generate() {
    ...
    $.ajax({
        type: 'GET',
        url: "scripts/roman-numbers/generate.php",
        data: input,
        success: function (result) {
            if (result == '0') {
                alert('Cannot generate questions for this range');
            } else {
                console.log(result);
...
function schedule() {
    Swal.mixin({
        ...
        if (result.value) {
            ...
            $.ajax({
                type: 'POST',
                url: "scripts/roman-numbers/schedule.php",
                dataType: "json",
...
function check(q) {
    ...
    $.ajax({
        type: 'GET',
        url: "scripts/roman-numbers/check.php",
        data: {
            'ans': ans,
            'cans': cans
        },
